...
export const presets: Record<string, ThemePreset> = {
  'Maia': {
    ...
    panelStyle: 'flat',
    light: {
      primary: '#18181b', secondary: '#7c3aed', background: '#f8fafc', surface: '#ffffff', surfaceRaised: '#ffffff',
      foreground: '#0f172a', muted: '#64748b', border: '#e2e8f0', success: '#16a34a', error: '#dc2626',
    },
    dark: {
      primary: '#fafafa', secondary: '#a78bfa', background: '#09090b', surface: '#111113', surfaceRaised: '#18181b',
      foreground: '#fafafa', muted: '#a1a1aa', border: '#27272a', success: '#4ade80', error: '#fb7185',
    },
  },
  'Terminal Mint': {
    ...
    panelStyle: 'flat',
    light: {
      primary: '#087f5b', secondary: '#0f766e', background: '#f4f8f6', surface: '#ffffff', surfaceRaised: '#f9fbfa',
      foreground: '#101814', muted: '#607068', border: '#d7e1dc', success: '#0f9f6e', error: '#dc4c64',
    },
    dark: {
      primary: '#3ee6a7', secondary: '#5eead4', background: '#080d0b', surface: '#0d1411', surfaceRaised: '#121b17',
      foreground: '#e8f5ef', muted: '#7e958a', border: '#203029', success: '#3ee6a7', error: '#ff667d',
    },
  },
  'Perps Violet': {
    ...
    panelStyle: 'soft',
    light: {
      primary: '#6554c0', secondary: '#8b5cf6', background: '#f7f7fb', surface: '#ffffff', surfaceRaised: '#fbfaff',
      foreground: '#171526', muted: '#716e83', border: '#e4e1ed', success: '#159570', error: '#d84f68',
    },
    dark: {
      primary: '#9b87f5', secondary: '#c084fc', background: '#0b0a10', surface: '#121118', surfaceRaised: '#191721',
      foreground: '#f0eef7', muted: '#8c879e', border: '#292633', success: '#42d3a2', error: '#ff6b83',
    },
  },
  'Neon Liquidity': {
    ...
    panelStyle: 'glow',
    light: {
      primary: '#167d3d', secondary: '#008c9e', background: '#f4fff8', surface: '#ffffff', surfaceRaised: '#f7fffb',
      foreground: '#08130d', muted: '#587064', border: '#cde7d8', success: '#10a866', error: '#e54867',
    },
    dark: {
      primary: '#b7ff3c', secondary: '#27e8d1', background: '#050706', surface: '#0a0e0c', surfaceRaised: '#0f1512',
      foreground: '#f3ffe9', muted: '#7d9386', border: '#1d2d24', success: '#69f5ad', error: '#ff5f79',
    },
  },
  'Midnight Exchange': {
    ...
    panelStyle: 'soft',
    light: {
      primary: '#2563eb', secondary: '#0284c7', background: '#f4f7fb', surface: '#ffffff', surfaceRaised: '#f8fbff',
      foreground: '#101828', muted: '#667085', border: '#dfe5ee', success: '#12966f', error: '#d94c61',
    },
    dark: {
      primary: '#5aa7ff', secondary: '#38bdf8', background: '#07101d', surface: '#0b1626', surfaceRaised: '#102036',
      foreground: '#edf5ff', muted: '#8294ab', border: '#1c3049', success: '#45d5a5', error: '#ff6b7f',
    },
  },
}
    ...
    components: {
      MuiCssBaseline: {
        styleOverrides: {
          ...
          '::selection': { background: alpha(t.primary, .25) },
        },
      },
      ...
      MuiCard: {
        styleOverrides: { root: { backgroundColor: t.surface, boxShadow: panelShadow, borderColor: t.border } },
      },
      MuiOutlinedInput: {
        styleOverrides: {
          root: {
      ...
      MuiTooltip: {
        styleOverrides: {
          tooltip: { background: isDark ? '#f4f4f5' : '#111827', color: isDark ? '#111827' : '#fff', fontSize: 12, borderRadius: Math.max(4, t.radius - 2) },
        },
      },
    },
  })
